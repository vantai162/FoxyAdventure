...
@export var break_delay: float = 2.5        # thời gian chờ trước khi vỡ CHAM (reduced from 3.0)
...
@export var respawn_time: float = 4.0       # thời gian hồi sinh sau khi biến mất (reduced from 5.0)
